...
//---------------------------------------------------------------------------------------------------
float pid_p_gain_roll = 3;               //Gain setting for the roll P-controller //1.3
float pid_i_gain_roll = 0.01;              //Gain setting for the roll I-controller //0.04
float pid_d_gain_roll = 15.0;              //Gain setting for the roll D-controller //18.0
...
void setup(){
  ...
  PCMSK0 |= (1 << PCINT19);//***** digital input 3
...
void loop(){
  ...
  if(receiver_input_channel_3 < 1050 && receiver_input_channel_5 > 1400)start = 1;
  ...
  if(start == 2 && receiver_input_channel_3 < 1050 && receiver_input_channel_5 < 1100)start = 0;
  ...
  //if(micros() - loop_timer > 4050)Serial.println("Warning, loop time is over 4 ms"); **************************Testing
...
ISR(PCINT0_vect){
  ...
  if(PIND & B00001000 ){                                                    //Is input 3 high?
    if(last_channel_5 == 0){                                                //Input 3 changed from 0 to 1.
      last_channel_5 = 1;                                                   //Remember current input state.
      timer_5 = current_time;                                               //Set timer_5 to current_time.
    }
  }
  else if(last_channel_5 == 1){                                             //Input 3 is not high and changed from 1 to 0.
...
void gyro_signalen(){
  ...
  if(eeprom_data[31] == 1){
    ...
    if((PINB & _BV (4)) == 1){                                              //If pin12 is high pull back (ultra sonic sensor)
      receiver_input_channel_2 = 1400;
    }
